...
const HelpnSupport = () => {
  return (
    <div className='w-[90%] mx-auto py-8 overflow-hidden p-4 '>
        ...
        <div className='flex-col py-8 sm:flex-row flex gap-8 justify-center h-auto'>
            <div className='md:w-[20rem] lg:w-[24rem] lg:max-w-[25rem] md:max-w-[21rem] mt-[2rem] sm:mt-0 px-3 py-6 rounded-lg text-center hover:shadow-none hover:border-2 hover:border-black shadow-md shadow-[#091751] gap-8 flex flex-col'>
               ...
               <span className='block'>
                    Telephone-one (help and support) : +0128121919
                    </span>
                <span>
                 Telephone-two (customer care): +0128121919
                </span> 
                </div>     
            </div>          

            <div className=' md:w-[20rem] lg:w-[24rem] lg:max-w-[25rem] md:max-w-[21rem] text-center rounded-md px-2 py-6 hover:shadow-none hover:border-2 hover:border-black shadow-md shadow-[#091751] '>
